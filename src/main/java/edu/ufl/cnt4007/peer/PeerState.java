...
public class PeerState {
    ...
    public PeerState(PeerInfo peerProcessInfo, List<PeerInfo> allPeers, Bitfield myBitfield,
    ...
    /**
     * Calculate download rates for each peer based on bytes downloaded in the
     * interval.
     * The interval is the unchoking interval defined in the config.
     */
    public void calculateDownloadRates() {
        ...
        for (Map.Entry<Integer, Long> entry : bytesDownloadedInInterval.entrySet()) {
            ...
            System.out.println("[DEBUG] Peer " + peerId + " downloaded " + bytes + " bytes in last "
                    + interval + " seconds. Rate: " + rate + " bytes/sec");

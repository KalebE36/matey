...
public class PeerProcess implements PeerContext, Runnable {
    ...
    public PeerProcess(int peerId, ConfigLoader configLoader) {
        PeerInfo peerProcessInfo = new PeerInfo(peerId, configLoader.getPeerConfig().getPeerInfo(peerId).getHost(),
        ...
        Bitfield myBitfield = new Bitfield(configLoader.getCommonConfig().getFileSize(),
                configLoader.getCommonConfig().getPieceSize(), peerProcessInfo.isHasFile());

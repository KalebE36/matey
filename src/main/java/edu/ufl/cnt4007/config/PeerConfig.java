...
public class PeerConfig {
        ...
        try ( // Parse PeerInfo.cfg
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 4) {
                    ...
                    PeerInfo peerInfo = new PeerInfo(peerId, parts[1], Integer.parseInt(parts[2]),
                            parts[3].equals("1"));
    ...
    public String toString() {
        ...
        for (PeerInfo info : peerInfoMap.values()) {
            sb.append(info.peerId).append(" ").append(info.host).append(" ").append(info.port).append(" ")
                    .append(info.hasFile ? "yes" : "no").append("\n");
        }
        return sb.toString();
    }
}

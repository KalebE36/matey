...
/**
 * Listener is responsible for accepting incoming connections from other peers. For each accepted
 * connection, it spawns a new ConnectionHandler to manage communication.
 */

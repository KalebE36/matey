...
public class DownloadManager {
  ...
  public DownloadManager(int peerId, String fileName, long fileSize, int pieceSize, Bitfield bitfield) throws IOException{
  ...
  public synchronized void writePiece(int pieceIndex, byte[] data) throws IOException{
    ...
    if(data.length != expectedSize){
      throw new IOException("Piece size mismatch. Expected: " + expectedSize + ", got: " + data.length);
    }
